...
from graded_reader.adapters.base import AdaptedText
from graded_reader.adapters.claude_cli import ClaudeCliAdapter
from graded_reader.adapters.inbox import InboxError, pending, read
from graded_reader.lexicon import CoverageReport, LexiconError, coverage
from graded_reader.lexicon.bands import band_for, load_bands, load_ngsl
from graded_reader.lexicon.models import LEVELS, Band, level_index, parse_level
...
def build_profile(
    ...
    *,
    ...
    The level falls back to the one stored in settings, so ``reader profile``
